                                            ...
                                            if(not xrayname.startswith('Series 001')):  
                                                for dicomfilename in [f.path for f in scandir(xray) if f.is_file()]: 
                                                    if(dicomfilename.endswith('.dcm')):
                                                        ...
                                                        xraynum += 1  
                                                        try:
                                                            mkdir(cwd + '/CHR/' + set_label + '/RAID_ELBOW_3/patient' + str(patient_id))
                                                            mkdir(cwd + '/CHR/' + set_label + '/RAID_ELBOW_3/patient' + str(patient_id) + '/study1' + folderSuffix)
                                                        except FileExistsError:
                                                            pass
                                                        ...
                                                        output_path = cwd + '/CHR/' + set_label + '/RAID_ELBOW_3/patient' + str(patient_id) + '/study1' + folderSuffix + '/' + output_filename
                                                        ...
                                                        train_image_paths.writerow([set_label + '/RAID_ELBOW_5/patient' + str(patient_id) + '/study1' + folderSuffix + '/' + output_filename, dicomfilename.split('RAID')[1], label])             
                                                        if(r <= test):
                                                            test_num += 1
