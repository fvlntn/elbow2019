...
# imageData2, imageDataloaders2, type2 = data.getData('crop512-study', dataset, 'crop2-512-3_loss', [set], batch_size)
...
# model2 = test.load('./savedOldModels/' + 'crop2-512-3_loss' + '.pth', model2)
...
modelsList = [model3, model4]
dlList = [imageDataloaders3[set], imageDataloaders4[set]]
